    ...
    >
      <div>
        <h1
          ...
          className="font-bold text-4xl cursor-pointer text-[#142057]"
        >
          MockQ
        </h1>
      </div>
      <div className="">
        <ul className="flex space-x-20 font-bold text-[#142057] ">
          <li className="cursor-pointer">
            <Link to="/candidate/outsourced-interviews">
              Outsourced Interviews
            </Link>
          </li>
          <li className="cursor-pointer">
            <Link to="/candidate/analytics">Analytics</Link>
          </li>
          <li className="cursor-pointer">
            <Link to="/candidate/community-chat">Community</Link>
          </li>
        </ul>
      </div>

...
import { forgorPassword, resetPassword } from '../../api/interviewerApi';
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-600">
                {showResetForm ? 'Enter the OTP and your new password' : 'No worries! We will send you reset instructions.'}
              </p>
            </div>
            ...
            <div className="mt-6 text-center">
              <Link to="/interviewer/login" className="text-sm font-medium text-indigo-600 hover:text-indigo-500">
...
const ResetForm: React.FC<{
  ...
  <form className="mt-8 space-y-6" onSubmit={onSubmit}>
    ...
    <InputField
      ...
      errors={errors}
      validationRules={{ 
        validate: (value: string) => value === getValues('newPassword') || "Passwords do not match" 
      }}
    />

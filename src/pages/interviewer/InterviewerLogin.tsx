...
import { verifyLogin } from "../../api/interviewerApi";
...
const InterviewerLogin = () => {
  ...
  return (
    ...
    <div className="flex items-center bg-[#D9E9FF] justify-center h-screen w-full px-5 sm:px-0">
      <div className="flex bg-white rounded-lg shadow-lg border overflow-hidden max-w-sm lg:max-w-4xl w-full">
        ...
        <div className="w-full p-8 lg:w-1/2">
          <p className="text-xl text-gray-600 text-center">Login as Interviewer</p>
          ...
          <div className="mt-8">
            <button className="bg-[#142057] text-white font-bold py-2 px-4 w-full rounded hover:bg-[#19328F]">
              Login
            </button>
          </div>
          </form>
